...
public class ContenedorCategorias extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(comboTipoUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 280, -1));

        lblNombre2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblNombre2.setText("Categoría general:");
        lblNombre2.setToolTipText("");
        add(lblNombre2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 180, -1));
        ...
        add(btnIniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 430, 120, -1));
        ...
        txfBusqueda.setText("Ingresa el nombre de la categoría a buscar");
